...
export function StatCard({
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-5 transition-all duration-200 hover:border-zinc-700/80 hover:bg-zinc-900/80"
    >
      ...
      <div className="relative flex items-start justify-between">
        ...
        {Icon && (
          <div className={cn("shrink-0 rounded-xl bg-zinc-800/80 p-2.5", iconColor)}>
            <Icon size={16} />
          </div>
        )}
      </div>
